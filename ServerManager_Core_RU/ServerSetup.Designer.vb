...
Partial Class ServerSetup
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Настройки сервера"
        '
        'GroupBox1
        '
        ...
        Me.Label7.Text = "Стардантный порт 25000"
        '
        'Label6
        '
