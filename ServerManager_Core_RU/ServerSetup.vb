...
Public Class ServerSetup
    ...
    Private Sub StartServer_Click(sender As Object, e As EventArgs) Handles StartServer.Click
        ...
        If PortBox.TextLength > 6 Then
            MsgBox("порт не существует", MsgBoxStyle.Critical, "Ошибка")
            PortBox.Text = "25000"
            Exit Sub
        End If
        ...
        If ServerWorld.ToString = "Вы не выбрали настройки" Then
            MsgBox("Пожалуйста выберите Мир!", MsgBoxStyle.Critical, "Ошибка")
            Exit Sub
        End If

        If SaveFile.ToString = "Вы не выбрали настройки" Then
            MsgBox("Пожалуйста выберите место сохранения!", MsgBoxStyle.Critical, "Ошибка")
            Exit Sub
        End If
        If Port = "" Then
            MsgBox("Пожалуйста выберите порт сервера!", MsgBoxStyle.Critical, "Ошибка")
            Exit Sub
        End If
