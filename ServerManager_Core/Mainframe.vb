...
Public Class Mainframe
    ...
    Private Sub Mainframe_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Console_Display.Items.Add("[SERVER] Server launched on the IP " + GetIP() + ":" + ServerSetup.Portbox.Text)
    ...
    Private Sub Commands()
        ...
        If Command = "shutdown" Then
            ...
            Console.Add("[ERROR] Please use either 'shutdown game' or 'shutdown application' ")
        End If

        If Command = "shutdown server" Then
            Killserver()

            Console.Add("[SERVER] Server killed! ")
            Console.Add("[APPLICATION] Shut down? type 'shutdown application'")
        End If

        If Command = "help" Then
            Console.Add("[SERVER] Here are the commands")
        ...
        If Command = "port" Then
            Console.Add("[SERVER] Your port is " + ServerSetup.Portbox.Text)
        End If



        If Command = "daftpunk" Then
            Console.Add("[DAFTPUNK] You cant stop it now!")

        End If

        If Command = ("ip local") Then
            Console.Add("[HOST] Your local ip is " + LocalHostaddress.ToString)
        End If

        If Command = ("ip global") Then
            Console.Add("[HOST] Your global ip is " + GetIP())
        End If
